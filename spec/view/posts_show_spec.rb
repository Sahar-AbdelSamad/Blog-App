...
RSpec.describe 'Posts', type: :system do
  describe 'Show' do
    before(:all) do
      ...
      @p1 = Post.create(id: 901, title: 'post1', comments_counter: 0, likes_counter: 0, text:
        'a generation lost in space', author_id: 1234)
      ...
      @p3 = Post.create(id: 903, title: 'post3', comments_counter: 0, likes_counter: 0, text: 'the day the music died',
                        author_id: 1234)
      @p4 = Post.create(id: 904, title: 'post4', comments_counter: 0, likes_counter: 0, text: 'bye, bye, miss american
        pie', author_id: 1234)
